...
<html>
	<head>
		<title>Зураг дарах</title>
		 <link rel="stylesheet" href="http://dataurl.net/style.css?1" type="text/css">
		<meta charset="utf-8">
		<style>
		...
		<script language="JavaScript" src="dataurl.js"></script>		
		<script> 
			$(document).ready(Init);
		</script> 
	...
	<body>
		...
		<div id="body_dataurlmaker" class="page">						
			<div id="fileselectform">
				<form id="upload-form" target="myiFrame" action="http://dataurl.net/cgi-bin/dataurl.pl" method="POST" enctype='multipart/form-data' style="display: inline;">
				<p>Select or drag a file to get the Data URL: 
					<input type='file' name="file" id='fileinput' style="display: inline;">
					<input type='hidden' name='action' value='encode' style="display: inline;">
				</p>
				</form>
				<iframe name="myiFrame" id="postframe"></iframe>
			</div>
			...
			<div id="dataurldisplay">
				...
				<div id="dataurltextwrap"  style="display:none">
					
					<h3 id="dataurlfilename" class="lowmargin">Data URL</h3>
					<textarea id="dataurltextarea"></textarea>
					<p id="dataurlfilesize"></p>
				</div>
				
				<div id="dataurlimgview">
					<h3 class="lowmargin">Image preview</h3>
					<div id="dataurlimg"></div>
				</div>
