...
<html>
	<head>
		...
		<script> 
			...
			function base64_toimage() {
				...
				window.opener.$('#<%=id%>').attr("src","data:image/jpeg;base64,"+$.scriptcam.getFrameAsBase64());								
				//window.opener.$('#_uri').val("data:image/jpeg;base64,"+$.scriptcam.getFrameAsBase64());
				...
				var uri = "data:image/jpeg;base64,"+$.scriptcam.getFrameAsBase64(); 
				saveRentgenImage(field, uri, orderID);
			};
	...
	<body>
		...
		<div style="width:600px;float:left;">		
			...
			<br/><br/>
			<p><img id="uimage" style="width:600px;height:250px;"/></p>
		</div>
